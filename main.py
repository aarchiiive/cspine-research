...
if __name__ == "__main__":
    ...
    [wandb 로그인 설정하는 방법]
    reference : https://docs.wandb.ai/quickstart, https://greeksharifa.github.io/references/2020/06/10/wandb-usage/
    - conda, venv(가상환경) 설치 권장

    """
    # train("images", "lab01", "resnext50", batch_size=2, num_workers=8, use_wandb=True, project_name="cspine-research") # wandb 사용하기
    train("images", "lab02", "efficientnet_v2_l", batch_size=2, num_workers=8) # wandb 사용 안하기